...
(function() {
  ...
  require(['jquery', 'game', 'scene', 'renderer', 'player', 'creature', 'wizard', 'lumberjack', 'fisherman', 'stats'], function($, g, s, r, player, Creature, wizard, Lumberjack, Fisherman, Stats, astar, Graph) {
