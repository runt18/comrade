...
(function() {
  ...
  require(['jquery', 'game', 'scene', 'renderer', 'player', 'creature'], function($, g, s, r, player, Creature) {
    var animate, change_keys, keys_down, load_music, load_textures, music, render, tick;
